# A Relational Database for Medieval Latin Biblical Manuscripts
...
* [the code to set up the database within a Postgres database instance](https://github.com/dslab-uniud/Database-biblical-manuscripts/tree/main/Database)
* the code to import the raw Excel file into the database: **TO-DO**
* [the code of some queries that show how to use the database](https://github.com/dslab-uniud/Database-biblical-manuscripts/tree/main/Database)
